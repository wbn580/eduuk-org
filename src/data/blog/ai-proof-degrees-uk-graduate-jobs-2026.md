...
pubDatetime: 2026-05-04T15:32:00Z
title: "AI-Proof Degrees: What to Study in the UK as Automation Reshapes the Graduate Job Market"
slug: ai-proof-degrees-uk-graduate-jobs-2026
featured: false
draft: false
tags:
  - Careers
...
- **AI users** (approximately 95% of graduates): professionals who use AI tools to amplify their effectiveness within an existing domain. An architect using AI to generate initial designs, a lawyer using AI to accelerate discovery, a teacher using AI to personalise lesson plans. Their competitive edge is domain expertise plus AI fluency.
- **AI governors** (approximately 3–5% of graduates): the people designing, training, auditing, and regulating AI systems. This path requires deep technical knowledge plus interdisciplinary breadth—computer science plus law, or statistics plus philosophy.
