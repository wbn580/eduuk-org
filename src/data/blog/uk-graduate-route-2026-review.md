...
1. **Online-only submission**: All applications must be submitted via UKVI's online portal; postal applications are no longer accepted.
2. **Extended grace period**: Graduates now have up to 4 months (increased from 3 months) following course completion to submit their Graduate Route application.
3. **Reduced fees**: The application fee has been reduced from GBP 284 to GBP 189 for online applications submitted before June 2026.
...
**Salary requirement under Skilled Worker (2026 rates):**
The Standard Occupation Classification (SOC) now uses a variable salary threshold:
...
1. Graduate Route (2 or 3 years) → Skilled Worker visa (typically 5 years) → ILR after 5 years on Skilled Worker.
2. Alternative: Spouse / Civil Partner visa pathway (if married to UK citizen or settled person) → ILR after 2 years.
3. Long-Residence pathway: 10+ years continuous UK residence in any combination of visas → ILR.
