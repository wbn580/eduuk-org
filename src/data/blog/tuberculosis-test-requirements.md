...
pubDatetime: 2025-04-05T08:45:00Z
title: "Tuberculosis Test Requirements: TB Screening for Student Visas"
slug: tuberculosis-test-requirements
featured: false
draft: false
tags: ["Visa"]
description: "Which countries require TB screening, how to book a test, how long results take, and what to do if your test is positive."
---
...
See the [full list on gov.uk](https://www.gov.uk/guidance/tuberculosis-test-and-report-for-a-uk-visa-application).
...
**Step 1**: Locate an UKVI-approved TB clinic in your country. Check the [gov.uk list of approved clinics](https://www.gov.uk/guidance/tuberculosis-test-and-report-for-a-uk-visa-application#approved-clinics-lists).
...
1. Remove metal objects (necklaces, bras with metal)
2. Stand in front of an X-ray machine
3. Hold still while your chest is imaged
...
1. Travel to a neighbouring country where an approved clinic is available
2. Request a referral from your local health authority to an approved clinic
3. Contact UKVI for alternative arrangements (email the visa centre for your country)
...
1. Scan a colour copy
2. Upload it to your Student Route visa application under the relevant section
...
- gov.uk: [Tuberculosis Test and Report for a UK Visa Application](https://www.gov.uk/guidance/tuberculosis-test-and-report-for-a-uk-visa-application)
- UKVI Immigration Rules, Appendix T (Tuberculosis)
- NHS: [Tuberculosis Information for Visitors to the UK](https://www.nhs.uk)
